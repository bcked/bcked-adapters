...
describe("closest", () => {
    ...
    it("returns the exact item for the timestamp", () => {
        expect((0, array_1.closest)(mockData, "2022-04-08T00:00:00.000Z")).toEqual({
            timestamp: "2022-04-08T00:00:00.000Z",
        });
        expect((0, array_1.closest)(mockData, "2022-04-09T00:00:00.000Z")).toEqual({
            timestamp: "2022-04-09T00:00:00.000Z",
        });
        expect((0, array_1.closest)(mockData, "2022-04-10T00:00:00.000Z")).toEqual({
            timestamp: "2022-04-10T00:00:00.000Z",
        });
    });
    it("returns the closest timestamp in the array", () => {
        expect((0, array_1.closest)(mockData, "2022-04-08T12:00:00.000Z")).toEqual({
            timestamp: "2022-04-08T00:00:00.000Z",
        });
        expect((0, array_1.closest)(mockData, "2022-04-09T12:00:00.000Z")).toEqual({
            timestamp: "2022-04-09T00:00:00.000Z",
        });
        expect((0, array_1.closest)(mockData, "2022-04-10T12:00:00.000Z")).toEqual({
            timestamp: "2022-04-10T00:00:00.000Z",
        });
    });
    it("returns the first item in the array if the timestamp is before the first item", () => {
        expect((0, array_1.closest)(mockData, "2022-04-07T12:00:00.000Z")).toEqual({
            timestamp: "2022-04-08T00:00:00.000Z",
        });
    });
    it("returns the last item in the array if the timestamp is after the last item", () => {
        expect((0, array_1.closest)(mockData, "2022-04-11T12:00:00.000Z")).toEqual({
            timestamp: "2022-04-10T00:00:00.000Z",
        });
    });
});
describe("relativeInMs", () => {
    ...
    it("returns the closest timestamp within small deviation from the relative time", () => {
        ...
        const result1 = (0, array_1.relativeInMs)(mockData, interval, deviation);
        ...
        const result2 = (0, array_1.relativeInMs)(mockData, interval * 2, deviation);
        ...
        const result3 = (0, array_1.relativeInMs)(mockData, interval * 3, deviation);
        expect(result3).toEqual(undefined);
    });
    it("returns the closest timestamp within small deviation from the relative time", () => {
        const interval = 24 * 60 * 60 * 1000; // 1 day in milliseconds
        // Test with a timestamp exactly 3 days before the latest timestamp
        const result3 = (0, array_1.relativeInMs)(mockData, interval * 3, 1 / 3);
    ...
    it("returns undefined if there is no timestamp within deviation from the relative time", () => {
        ...
        const result1 = (0, array_1.relativeInMs)(mockData, interval * 4, deviation);
        expect(result1).toEqual(undefined);
        // Test with a timestamp exactly 5 days before the latest timestamp
        const result2 = (0, array_1.relativeInMs)(mockData, interval * 5, deviation);
